...
def main():
    ...
    for ind in current_population:
        [f, g, c1, c2, k1_f, k2_f, k1_g, k2_g] = ind
    ...
    if(num_parents_mating >= 4):
        i3 = Individual(ni[2].f, ni[2].g, ni[3].c1, ni[3].c2, ni[3].k1_f, ni[3].k2_f, ni[3].k1_g, ni[3].k2_g)
        i4 = Individual(ni[3].f, ni[3].g, ni[2].c1, ni[2].c2, ni[2].k1_f, ni[2].k2_f, ni[2].k1_g, ni[2].k2_g)
        new_children_by_crossover.append(i3)
        new_children_by_crossover.append(i4)
